...
class TransformerEncoder(nn.Module):
    def __init__(self, embed_dim, num_heads, depth, ratio, dropout=0.0):
...
class CNN_Transformer(nn.Module):
    def __init__(self, cfg: DictConfig):
        ...
        transformer_depth = getattr(cfg.model, "transformer_depth", 2)
        transformer_dropout = getattr(cfg.model, "transformer_dropout", 0.0)
