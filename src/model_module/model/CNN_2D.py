...
@register_model('CNN_2D')
class CNN_2D(nn.Module):
    def __init__(self, cfg: DictConfig):
        super(CNN_2D, self).__init__()
        self.cfg = cfg
        self.encoder = CNN_backbone(cfg, stem_chs=[64, 256, 64], depths=[cfg.model.stage1_depth, cfg.model.stage2_depth, cfg.model.stage3_depth, cfg.model.stage4_depth], path_dropout=0.2)
